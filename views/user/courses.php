                                                    ...
                                                    <div class="tab-content-wrapper">
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <!-- author and rating-->
                                                                <div class="grid grid-cols-1 pt-15px border-t border-borderColor">
                                                                    <div>
                                                                        <a
                                                                            ...
                                                                            <img class="w-[30px] h-[30px] rounded-full mr-15px" src="../../assets/images/<?php echo $course['imageProfile'] ?>" alt="">
